...
depart_fin = open('department.txt', 'r', encoding='utf-8')
insert_department()
teacher_fin = open('teacher.txt', 'r')
insert_teacher()
classroom_fin = open('classroom.txt', 'r')
insert_classroom()
time_slot_fin = open('time_slot.txt', 'r')
insert_time_slot()
course_fin = open('course.txt', 'r')
insert_course()
section_fin = open('section.txt', 'r')
insert_section()
teaches_fin = open('teaches.txt', 'r')
insert_teaches()
student_fin = open('stu_empty_credits.txt', 'r')
insert_student()
takes_fin = open('takes_sql.txt', 'r')
insert_takes()
conn.commit()
cursor.close()
conn.close()